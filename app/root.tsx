	...
	return (
		<html lang="en" className="dark h-full">
			...
			<body className="flex h-full flex-col justify-between">
				...
				<header className="container mx-auto pb-1 pt-4">
					<nav className="mx-2 flex justify-end">
						{/* <Link to="/">
		...
		<DropdownMenu.Root>
			<DropdownMenu.Trigger asChild>
				<Link
					...
					className="flex items-center gap-2 rounded-full bg-white py-2 pl-2 pr-4 outline-none hover:bg-night-400 focus:bg-night-400 radix-state-open:bg-night-400"
				>
					<img
